...
(
   ...
   execute execute (
      ...
      .dmem_raddr       (dmem_read_offset),  // FIXED: 2-bit wire instead of 32-bit
      ...
      .mem_alu_operation(wb_alu_operation)  // FIXED: Passed correct 3-bit wire
   );
   ...
   wb wb_stage (
      ...
      .mem_write_i         (wb_mem_write),  // FIXED: Used the pipeline-delayed signal
